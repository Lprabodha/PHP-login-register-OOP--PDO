...
if (isset($_POST['register'])) {
    ...
    if (!array_filter($errors)) {
        ...
        if ($stmt->rowCount()) {
            ...
            // select the newly registerd user and store it in a session
        ...
        <div class="col-md-5 mx-auto">
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password1" value="<?php echo $password1 ?>" id="password1" class="form-control">
                    <div class="text-danger">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password2" value="<?php echo $password2 ?>" id="password2" class="form-control">
                    <div class="text-danger">
